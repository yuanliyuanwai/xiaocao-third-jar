package in.xiaocao.quartz.practise.example4;
...
public class JobStateExample {
	...
	public void run() throws Exception {
	    ...
	    Logger.info(job1.getKey() + " will run at: " + scheduleTime1 + " and repeat: " + trigger1.getRepeatCount() + " times, every " + trigger1.getRepeatInterval() / 1000L + " seconds");*/
